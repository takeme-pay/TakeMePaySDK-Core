...
- (instancetype)initWithClient:(TMPPaymentServiceClient *)client clientSecret:(NSString *)clientSecret sourceId:(NSString *)sourceId timeout:(NSTimeInterval)timeout completion:(void(^)(TMPPaymentRequestState state, NSError *))completion;
